...
details like Java home, service name, and port using plugin metadata. It also
consolidates library path usage and updates docs and tests to align with the
new layout rules.
