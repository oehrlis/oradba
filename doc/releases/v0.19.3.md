...
OraDBA v0.19.3 is a critical patch release that fixes incorrect status reporting for Oracle Data Safe On-Premises Connectors. This release addresses issues where connector status was shown as "UNKNOWN" even when processes were actively running, providing accurate status detection through a robust multi-layered approach.
