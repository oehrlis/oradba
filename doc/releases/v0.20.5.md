...
**Type:** Patch Release (Performance, Data Safe Operations, and Output Consolidation)

## Overview

Version 0.20.5 improves Data Safe connector status performance with cached
process detection and parallel checks, fixes connector operations to reliably
set connector-specific environment variables, and consolidates non-database
environment output across the CLI.
