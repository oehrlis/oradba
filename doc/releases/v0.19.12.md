...
1. ✅ Plugin cannot modify parent variables
2. ✅ Minimal Oracle environment available in plugin
3. ✅ Exit codes propagate correctly (0/1/2)
4. ✅ NOARGS support for no-arg functions
5. ✅ Result variable capture works
6. ✅ Returns error for missing function
7. ✅ Returns error for missing plugin
8. ✅ Function definitions isolated
9. ✅ Plugin modifications don't leak to parent
10. ✅ Strict error handling active (set -euo pipefail)
11. ✅ Extra argument support
12. ✅ LD_LIBRARY_PATH inherited when set
13. ✅ State changes don't persist
