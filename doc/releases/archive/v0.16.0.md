...
This release introduces a major enhancement to the extension system with the new
`add` command, comprehensive PATH/SQLPATH management improvements, and critical
bug fixes for extension loading.
...
#### Core oradba commands disappeared after login
...
#### Verbose output hiding important information
