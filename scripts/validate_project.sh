...
#              Checks for presence of all required files and directories.
...
check_file "${LIB_DIR}/oradba_common.sh"
check_file "${LIB_DIR}/oradba_db_functions.sh"
check_file "${LIB_DIR}/oradba_aliases.sh"
check_file "${LIB_DIR}/extensions.sh"

echo ""
echo "Checking Registry API (v0.19.0+)..."
check_file "${LIB_DIR}/oradba_registry.sh"

echo ""
echo "Checking environment management libraries (v0.19.0+)..."
check_file "${LIB_DIR}/oradba_env_parser.sh"
check_file "${LIB_DIR}/oradba_env_builder.sh"
check_file "${LIB_DIR}/oradba_env_validator.sh"
check_file "${LIB_DIR}/oradba_env_config.sh"
check_file "${LIB_DIR}/oradba_env_status.sh"
check_file "${LIB_DIR}/oradba_env_changes.sh"

echo ""
echo "Checking Plugin System (v0.19.0+)..."
check_dir "${LIB_DIR}/plugins"
check_file "${LIB_DIR}/plugins/plugin_interface.sh"
check_file "${LIB_DIR}/plugins/database_plugin.sh"
check_file "${LIB_DIR}/plugins/client_plugin.sh"
check_file "${LIB_DIR}/plugins/iclient_plugin.sh"
check_file "${LIB_DIR}/plugins/datasafe_plugin.sh"
check_file "${LIB_DIR}/plugins/oud_plugin.sh"
check_file "${LIB_DIR}/plugins/java_plugin.sh"
check_file "${LIB_DIR}/plugins/weblogic_plugin.sh" "false"
check_file "${LIB_DIR}/plugins/emagent_plugin.sh" "false"
check_file "${LIB_DIR}/plugins/oms_plugin.sh" "false"
