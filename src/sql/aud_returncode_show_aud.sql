...
-- -----------------------------------------------------------------------------
-- Name......: aud_returncode_show_aud.sql
-- Author....: Stefan Oehrli (oes) stefan.oehrli@oradba.ch
-- Editor....: Stefan Oehrli
-- Date......: 2026.03.31
-- Revision..: 0.21.0
-- Purpose...: Show failed operations from the Unified Audit Trail grouped by
--             return code. Excludes ORA-00000 (success). Useful for detecting
--             privilege errors, object access failures, and login failures.
...
SPOOL &LOGDIR./aud_returncode_show_aud_&DBSID._&TIMESTAMP..log
...
TTITLE 'Failed Operations by Return Code (last &days days, user=&user)'
