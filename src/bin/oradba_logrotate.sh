...
Options:
  ...
  -u, --uninstall       Uninstall logrotate configurations
...
Examples:
  # Install all logrotate configs (requires root)
  sudo ${SCRIPT_NAME} --install

  # Test configurations without rotating
  ${SCRIPT_NAME} --test

  # List installed configurations
  ${SCRIPT_NAME} --list

  # Generate customized configs for your environment
